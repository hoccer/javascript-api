var Linccer = function() {
  ...
  var load = function(scriptName, callbackFunctionName) {
    var jsonpName = 'jsonp' + Math.floor(Math.random() * 10000001);
    
    scriptURL =  "http://localhost:4567" + scriptName + "&jsonp=" + jsonpName;
	...
	var updateEnvironment = function() {
		...
		load("/clients/" + uuid + "/environment.js" +
					 ...
					 + "&longitude=" + that.longitude
							  + "&time=" + new Date().getTime()); // preventing caching by adding timestamp
	}
