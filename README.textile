...
bc. <script src="http://linccer.beta.hoccer.com/v3/linccer.min.js" type="text/javascript" charset="utf-8"></script>

Then initialize a new linccer. THe Linccer methods takes an options hash. An api key must be specified, additionally it
