...
var Linccer = function(_options) {
    ...
    var latitude, longitude, accuracy, timestamp, pubkey;
    var isReady;
    var timerId;
    ...
    that.publickeyed = function(data) {
      if (!hasError(data)) {
        that.fire('publickeyed', data);
      } 
    };


    that.deletedClient = function(data) {
      if (!hasError(data)) {
        that.fire('deletedClient', data);
    ...
    that.setpubkey = function(_pubkey) {
      pubkey = _pubkey
      updateEnvironment();
    };
    ...
    that.publickey = function(pubkey_id, data) {
      load("/clients/" + that.uuid + "/" + pubkey_id + "/publickey.js"
                                      , "publickeyed");
    };
